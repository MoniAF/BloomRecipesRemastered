...
<template>
  <!-- Footer all pages -->
    <footer class="container-total">
        <div class="f-principal mt-5" :class="{ 'fixed-footer': statusfooter }">
            <section class="container-pp">
                ...
                <p class="mb-0 txt-footer text-center"> © 2023 Copyright: <RouterLink :to="{ name: 'home' }" class="link-f"> Bloomrecipes.com </RouterLink></p>
